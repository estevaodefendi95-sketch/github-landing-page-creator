...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Estevão Defendi" },
      ...
      { name: "twitter:description", content: "Fluxo de caixa, DRE, planejamento e controle de inadimplência para profissionais autônomos e pequenas empresas." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/VWMmCbdJlhS2rkMlcOZ3l8kBSRo1/social-images/social-1784635159467-Gemini_Generated_Image_ytj6mhytj6mhytj6.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/VWMmCbdJlhS2rkMlcOZ3l8kBSRo1/social-images/social-1784635159467-Gemini_Generated_Image_ytj6mhytj6mhytj6.webp" },
    ],
    links: [
